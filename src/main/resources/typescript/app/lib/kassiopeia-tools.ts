...
export const locker = ScreenLockerKassiopeiaTool.fast.configureTo({
  background: '#000000',
  opacity: 0.8,
  bars: [
...
export const anim = AnimationKassiopeiaTool.fast
export const toaster = ToasterKassiopeiaTool.getConfigured({
